...
describe('CloudProjectService', () => {
  ...
  describe('createFromGitHub', () => {
    ...
    it('rejects duplicate GitHub repos', async () => {
      ;(mockProjectRepo.findByGitHubRepo as any).mockResolvedValueOnce({
        id: 'existing-project',
  ...
  describe('findByUserId', () => {
    it('returns projects for a user', async () => {
      ...
      ;(mockProjectRepo.findByUserId as any).mockResolvedValueOnce(mockProjects)
    ...
    it('returns empty array when user has no projects', async () => {
      ;(mockProjectRepo.findByUserId as any).mockResolvedValueOnce([])
  ...
  describe('findByGitHubRepo', () => {
    it('returns project for a GitHub repo', async () => {
      ...
      ;(mockProjectRepo.findByGitHubRepo as any).mockResolvedValueOnce(mockProject)
    ...
    it('returns null when project not found', async () => {
      ;(mockProjectRepo.findByGitHubRepo as any).mockResolvedValueOnce(null)
