...
ALTER TABLE "loop_output_chunks" ADD CONSTRAINT "loop_output_chunks_loop_run_id_loop_runs_id_fk" FOREIGN KEY ("loop_run_id") REFERENCES "public"."loop_runs"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "loop_runs" ADD CONSTRAINT "loop_runs_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
...
SELECT '52f85113e3f0af7c4a01e1b4338651ad0dc76719e8676ae2a5178e4ab77fabcf', 1773096297578
WHERE NOT EXISTS (
	SELECT 1
	FROM "drizzle"."__drizzle_migrations"
	WHERE "hash" = '52f85113e3f0af7c4a01e1b4338651ad0dc76719e8676ae2a5178e4ab77fabcf'
);
